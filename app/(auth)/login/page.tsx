      ...
      <div className="w-full max-w-md">
        <AnimatedDiv animation="slideInBottom">
          <Link href="/" className="mb-8 flex items-center justify-center gap-2">
            <Image src="/img/imagesmaldivesa/logoboho.png" alt="maldivian.tours" width={40} height={40} className="rounded-md" />
            <span className="text-2xl font-bold tracking-tight">maldivian.tours</span>
          </Link>
